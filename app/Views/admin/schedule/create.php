            ...
            <div class="card-body mt-3">
                ...
                <form action="<?= base_url('admin/schedules/store') ?>" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="time" class="form-control <?= ($validation->hasError('jam_mulai')) ? 'is-invalid' : '' ?>" id="jam_mulai" name="jam_mulai" value="<?= old('jam_mulai') ?>" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="time" class="form-control <?= ($validation->hasError('jam_selesai')) ? 'is-invalid' : '' ?>" id="jam_selesai" name="jam_selesai" value="<?= old('jam_selesai') ?>" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control <?= ($validation->hasError('kapasitas')) ? 'is-invalid' : '' ?>" id="kapasitas" name="kapasitas" value="<?= old('kapasitas') ?>" placeholder="Misal: 10" required>
                            <div class="invalid-feedback">
