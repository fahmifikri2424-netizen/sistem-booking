    ...
    <div class="col-lg-12">
        <div class="card premium-card">
            <div class="card-body mt-3">
                ...
                <form action="<?= base_url('admin/schedules/update/' . $schedule['id_schedule']) ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input class="form-check-input <?= ($validation->hasError('status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="statusAvailable" value="available" <?= (old('status', $schedule['status']) == 'available') ? 'checked' : '' ?>>
                                <label class="form-check-label" for="statusAvailable">
                                    Available
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input <?= ($validation->hasError('status')) ? 'is-invalid' : '' ?>" type="radio" name="status" id="statusBooked" value="booked" <?= (old('status', $schedule['status']) == 'booked') ? 'checked' : '' ?>>
